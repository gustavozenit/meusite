...
$dadosQA = "SELECT* FROM bins order by id asc limit 0,30";
        ...
        ***********************************-->
        <div class="content-body">
			...
			<div class="container-fluid">
				 ...
				 <div id="modal_search_bin" class="modal fade none-border show" id="event-modal" style="display: none; padding-right: 17px;" aria-modal="true" role="dialog">
                        <div class="modal-dialog">
                            <div class="modal-content">
							<form action="comment.php" method="post">
                                <div class="modal-header">
                                    <h4 class="modal-title"><strong>Pesquisar Bins</strong></h4>
                                </div>
								
                                <div class="modal-body">
								<p> <small>A pesquisa será feita dentro do banco de dados da tela, caso não exista no banco, você pode adicionar.</small> </p>

								<label>BIN</label>	
								
		                                 <div class="input-group mb-3 input-primary">
                                            <input id="bin_number" type="tel" class="form-control" maxlength="6">
                                            <div class="input-group-append">
                                                <a onClick="search_bins()" class="input-group-text" href="#"><i class="fa fa-search"></i></a>
                                            </div>
                                        </div>	
					
								<p> <small> <font id="msg_error_1" color="red"></font></small> </p>
								<p> <small> <font id="msg_success_1" color="green"></font></small> </p>
								
							 <center>
							 <div style="display: none;" id="loader_search_bin" ><img width="40" src="images/new/loader_1.gif"></div>
							 </center>
							...
							<div class="card-body pb-0">
								...
								<ul id="view_result_bin" class="list-group list-group-flush">
                                ...
                                <div class="modal-footer">
                                    <a type="button" onClick="$('#modal_search_bin').css('display', 'none');" class="btn btn-dark waves-effect" data-dismiss="modal">Fechar</a>
                                </div>
								</form>
                            </div>
                        </div>
				...
				<div class="row">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 onClick="art()" class="card-title">Gerenciar Bins</h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-list-group">
                                    <div class="row">
                                        <div class="col-lg-6 col-xl-2">
											...
											<a class="list-group-item list-group-item-action active"  href="bins.php" >
											Todas Bins
											</a> 	
											
											<a onClick="more_bins('w')" class="list-group-item list-group-item-action "  id="list-home-list" data-toggle="list"  href="#list-home"  role="tab" >
											Whitelist
											</a> 			
											<a onClick="more_bins('b')" class="list-group-item list-group-item-action "  id="list-home-list" data-toggle="list"  href="#list-home"  role="tab" >
											Blacklist
											</a> 	
											
											<a onClick="$('#modal_search_bin').css('display', 'block');" class="list-group-item list-group-item-action" id="list-home-list" data-toggle="list"  href="#list-home"  role="tab">
											<i class="fa fa-search"></i> Procurar Bin
											</a> 	
                                    ...
                                    <table class="table table-responsive-md">
										...
										<tr>	
											...
											<td><?php echo $consultaQA ['bin_number'] ?></td>
											<td><?php echo $consultaQA ['card_type'] ?></td>
											<td><?php echo $consultaQA ['card_band'] ?></td>
											<td><?php echo $consultaQA ['card_level'] ?></td>
											<td><?php echo $consultaQA ['card_bank'] ?></td>
											<td><?php echo $consultaQA ['card_pais'] ?></td>
									...
									<input type="hidden" value="30" id="bin_atual"> 
									<center>
									<button id="btn_more" onClick="more_bins('all')" type="button" class="btn btn-square btn-outline-light">Ver mais</button>
									<div style="display: none;" id="loader_img" ><img width="60" src="images/new/loader_1.gif"><br></div>
									</center>
                                </div>
