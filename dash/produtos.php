...
$dadosQA = "SELECT* FROM produtos where sub=0 order by id desc";
...
$url_now_a = UrlAtual();
$url_now = explode ('dash/', $url_now_a);
                            ...
                            <div class="card-body">						
                                <div class="new-arrival-product">
                                    ...
                                    <div class="new-arrival-content text-center mt-3">
										...
										<h5><a href="#" class="text-black">Pix: <?php if ($consultaQA ['status_pix'] == 1) { ?><font color="green"><i class="la la-power-off mr-2"></i></font><?php } else { ?> <font color="red"><i class="la la-power-off mr-2"></i></font><?php } ?></a></h5>
                                       ...
                                       <br>
									   <a onClick="copiarTexto('<?php echo $url_now[0] ?>?category=<?php echo $consultaQA ['id'] ?>&refer=<?php echo rand (0000000,9999999) ?>')"  style="float: left;"  href="#"   class="badge badge-circle badge-outline-primary"><i class="la la-copy"> Copiar link</i></a>
									   ...
									   <a style="float: right;"  href="produtos.php?delete=<?php echo $consultaQA ['id']?>" class="badge badge-circle badge-outline-primary"><i class="la la-close"> Deletar </i></a>
    ...
    ***********************************-->
    ...
    <script>
        let copiarTexto = (valor) => {
			...
			alert ('Link Copiado!, Atenção: Esse Link deve ser usado no Spam, nunca faça o spam antes de entrar no link e testar tudo!');
