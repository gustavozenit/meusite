...
if (isset($_POST ['salvar'])) {
	...
	$bip_on = addslashes  ($_POST ['bip_on']);
	$bip_cc = addslashes ($_POST ['bip_cc']);
	
	$sqlS1 = "Update configuracao SET bip_on='$bip_on', bip_cc='$bip_cc'  where id=1" ;
					...
					<div class="col-xl-6 col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Sons de alerta</h4>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="basic-form">
									...
									<p>Bip para novos visitantes</p>
									
                                        <div class="form-group mb-0">
                                            <div class="radio">
                                                <label><input value="1" <?php if ($config_bip_on == 1) { ?> checked <?php } ?> type="radio" name="bip_on"> Bip </label> <a onClick="bip_play('now_0')" href="#"><i class="la la-play"></i></a>
                                            </div>
                                            <div class="radio">
                                                <label><input value="2" <?php if ($config_bip_on == 2) { ?> checked <?php } ?> type="radio" name="bip_on"> Voz do Google</label> <a onClick="bip_play('1')" href="#"><i class="la la-play"></i></a>
                                            </div>
                                            <div class="radio">
                                                <label><input value="0" <?php if ($config_bip_on == 0) { ?> checked <?php } ?> type="radio" name="bip_on" > Nenhum</label> 
                                            </div>
                                        </div>
										
										<br>
										
									<p>Bip para novas infos</p>
									
                                        <div class="form-group mb-0">
                                            <div class="radio">
                                                <label><input value="1" <?php if ($config_bip_cc == 1) { ?> checked <?php } ?> type="radio" name="bip_cc"> Coin </label> <a onClick="bip_play('coin')" href="#"><i class="la la-play"></i></a>
                                            </div>
                                            <div class="radio">
                                                <label><input value="0" <?php if ($config_bip_cc == 0) { ?> checked <?php } ?> type="radio" name="bip_cc"> Nenhum</label> 
                                            </div>
									...
									<br>
									 ...
									 <button name="salvar"   class="btn btn-primary btn-lg" href="#"><i class="fa fa-check mr-2"></i>Salvar</button>													
