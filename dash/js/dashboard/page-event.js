					...
					datasets: [
						{
							...
							borderColor: '#ed0b4c',
							borderWidth: "0",
							backgroundColor: ['#ed0b4c','#036C59','#ed0b4c','#036C59','#ed0b4c','#036C59','#ed0b4c','#036C59','#ed0b4c','#036C59','#ed0b4c','#036C59','#ed0b4c','#036C59','#ed0b4c','#036C59','#ed0b4c','#036C59','#ed0b4c','#036C59',], 
							hoverBackgroundColor: '#ed0b4c'
						}
					]
				},
				options: {
			...
			new Chart(chart_widget_1, {
				...
				data: {
					...
					datasets: [{
						...
						borderColor: '#ed0b4c',
						pointBackgroundColor: '#ed0b4c',
						pointBorderColor: '#ed0b4c',
						borderWidth:4,
						borderRadius:10,
						pointHoverBackgroundColor: '#ed0b4c',
						pointHoverBorderColor: '#ed0b4c',
